...
- An Application Network member resource's Application Network, location, subscription, and resource group are fixed when it joins and can't be changed afterward.
