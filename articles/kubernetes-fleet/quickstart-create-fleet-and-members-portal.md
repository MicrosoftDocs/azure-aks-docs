...
1. In the member list:
    ...
    * Enter an **update group** for the member cluster so the cluster can be safely updated when the group is included in a Fleet Manager [update strategy](./update-create-update-strategy.md).
