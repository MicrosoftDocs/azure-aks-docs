...
Get started with Azure Kubernetes Fleet Manager using the Azure portal to create a Fleet Manager and join [supported Kubernetes clusters](./concepts-member-cluster-types.md) as members.
...
1. On the **Basics** tab, configure the following options:
    ...
    - Under **Fleet details**:
      ...
      :::image type="content" source="./media/quickstart-create-fleet-and-members-portal/create-fleet-manager-portal-basics.png" alt-text="Screenshot of the Create Fleet Manager basics tab in the Azure portal." lightbox="./media/quickstart-create-fleet-and-members-portal/create-fleet-manager-portal-basics.png":::

1. Select **Next: Member clusters**.
1. Select **+ Add** to add existing clusters, filtering the cluster list using the search box.

    :::image type="content" source="./media/quickstart-create-fleet-and-members-portal/add-fleet-members-portal.png" alt-text="Screenshot of the Create Fleet Manager add member cluster dialog in the Azure portal." lightbox="./media/quickstart-create-fleet-and-members-portal/add-fleet-members-portal.png":::

1. Select **Add** to add the selected clusters.
1. In the member list:
    ...
    - Enter an **update group**, such as _dev_, for the member cluster so the cluster can be safely updated when the group is included in a Fleet Manager [update strategy](./update-create-update-strategy.md).

     :::image type="content" source="./media/quickstart-create-fleet-and-members-portal/update-fleet-members-portal.png" alt-text="Screenshot of the Create Fleet Manager add member cluster name and update group options in the Azure portal." lightbox="./media/quickstart-create-fleet-and-members-portal/update-fleet-members-portal.png":::

1. Select **Next: Advanced**.
1. On the **Advanced** tab, configure the following options:

    - Select **Enable private hub cluster** to provision a private hub cluster with [API server VNet integration](../aks/api-server-vnet-integration.md).
        - **Virtual network**: Select an existing Azure virtual network (VNet) or select **Create new** to create a new VNet.
        - **Cluster subnet**: Select a VNet subnet for the hub cluster node.
        - **API server subnet**: Select a VNet subnet for the hub cluster's API server integration.
    - Select an existing [user assigned managed identity](/entra/identity/managed-identities-azure-resources/overview#managed-identity-types) or select **Create new** to create a new user-assigned managed identity.
    ...
    :::image type="content" source="./media/quickstart-create-fleet-and-members-portal/create-fleet-advanced-portal.png" alt-text="Screenshot of the Create Fleet Manager advanced tab in the Azure portal." lightbox="./media/quickstart-create-fleet-and-members-portal/create-fleet-advanced-portal.png":::
...
1. Select **Review + create** > **Create** to create the Fleet Manager.
    ...
    It takes a few minutes to create the Fleet Manager. When your deployment completes, you can select **Go to resource** to view the Fleet Manager.
...
- [Upgrade multiple clusters using Azure Kubernetes Fleet Manager update runs](./update-orchestration.md)
