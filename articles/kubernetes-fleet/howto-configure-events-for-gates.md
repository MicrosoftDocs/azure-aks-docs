---
title: "Configure Event Grid System Topics and Events for Update Run Approval Gates for Azure Kubernetes Fleet Manager"
description: Learn how to set up Event Grid to access Approval Gate events in Update Runs for Azure Kubernetes Fleet Manager.
ms.topic: how-to
ms.date: 09/22/2025
author: sjwaight
...
# Configure Event Grid System Topics and Events for Update Run Approval Gates for Azure Kubernetes Fleet Manager (Preview)

**Applies to:** :heavy_check_mark: Fleet Manager :heavy_check_mark: Fleet Manager with hub cluster

Fleet Manager provides [Approval Gates](./update-strategies-gates-approvals.md) for Groups and Stages in an Update Run to provide administrators with additional controls over the Update Run flow. Approval Gates publish events that can be subscribed to by using Event Grid System Topic Subscriptions.

This article provides instructions on how to configure an Event Grid System Topic and Subscriptions to support both notifications and automation integrations.
