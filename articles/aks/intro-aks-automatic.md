...
| Cluster tier | **Preconfigured**: Standard tier cluster with up to 5,000 nodes, a [cluster uptime Service Level Agreement (SLA)][uptime-sla], and a [pod readiness SLA][azure-sla] that guarantees 99.9% of pod readiness operations complete within 5 minutes. |  **Default**: Free tier cluster with 10 nodes but can support up to 1,000 nodes. <br/> **Optional**: <br> • Standard tier cluster with up to 5,000 nodes and a [cluster uptime SLA][uptime-sla]. <br> • Premium tier cluster with up to 5,000 nodes, [cluster uptime Service Level Agreement (SLA)][uptime-sla], and [long term support][long-term-support]. |
