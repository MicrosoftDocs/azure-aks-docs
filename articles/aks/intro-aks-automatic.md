...
| Policy enforcement | **Preconfigured**: [Deployment safeguards][deployment-safeguards] and [baseline Pod Security Standards][pod-security-standards] that enforce Kubernetes best practices in your AKS cluster through Azure Policy controls in enforcement mode. <br/> * [Security restrictions for managed system node pools][security-restrictions] protect managed system components and preserve the boundary between customer workloads and AKS-managed infrastructure. <br/> **Optional**:<br> * [Advanced Container Networking Services](how-to-apply-l7-policies.md) container network security for Cilium DNS and L7 policies. | **Optional**: [Deployment safeguards][deployment-safeguards] and [Pod Security Standards][pod-security-standards] enforce Kubernetes best practices in your AKS cluster through Azure Policy controls in enforcement mode or warning mode. <br/> **Optional**:<br> * [Advanced Container Networking Services ](how-to-apply-l7-policies.md) container network security for Cilium DNS and L7 policies |
