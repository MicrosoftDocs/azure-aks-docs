...
| Service mesh | **Optional**: <br> * [Istio CNI add-on][istio-cni]. | **Optional**: <br> * [Azure Service Mesh (Istio)][istio-mesh] <br> * Bring your own service mesh. |
