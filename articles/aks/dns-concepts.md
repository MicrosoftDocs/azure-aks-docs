...
description: Learn how DNS operates in AKS, including default settings, pod and service resolution, and how to boost performance and reliability with localDNS caching.
...
This architecture ensures a balance between flexibility and operational safety in a managed environment. For details on how to customize CoreDNS in AKS, refer to the [CoreDNS customization guide](/articles/aks/coredns-custom.md).
...
> [!NOTE]
> This document provides an overview of what LocalDNS is and its benefits in AKS. It does not include setup instructions. For guidance on enabling and configuring LocalDNS, see the [LocalDNS how-to guide](/articles/aks/localdns-custom.md).
...
To learn how to enable LocalDNS and configure its settings in your AKS cluster, see the [LocalDNS how-to guide](/articles/aks/localdns-custom.md).
