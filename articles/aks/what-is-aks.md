...
| **Node management** | Fully managed - Azure provisions, scales, and upgrades nodes automatically using [node auto-provisioning](./node-auto-provisioning.md) | You create and manage node pools manually |
