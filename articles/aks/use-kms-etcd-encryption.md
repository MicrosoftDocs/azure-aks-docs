...
>
> KMS supports only [API Server VNet Integration (preview)][api-server-vnet-integration] for private key vaults. Public key vaults also support VNet Integration.
>
