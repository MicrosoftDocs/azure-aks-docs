...
- If you are using the [Managed NGINX ingress with the application routing add-on](https://learn.microsoft.com/en-us/azure/aks/app-routing) on AKS, the patches are getting rolled out to all regions with the AKS 2050316 release. **No action is required**. You can check the release status from [AKS release tracker][aks-release-tracker].
