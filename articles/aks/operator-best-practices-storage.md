...
To expose NVMe capacity to pods, use [Azure Container Storage][azure-container-storage]. Azure Container Storage orchestrates the local disks and can create ephemeral **or** persistent volumes backed by NVMe, whereas the Azure Disk CSI driver only provisions Azure Managed Disks. For implementation guidance, see [Use Azure Container Storage with AKS][use-azure-container-storage].
