...
1. Select the ACR instance that you want to test.
...
For more information about this experience, see [Deploy AKS CanIPull and troubleshoot image pull issues][copilot-canipull].
