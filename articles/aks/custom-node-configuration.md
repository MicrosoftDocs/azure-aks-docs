...
| `seccompDefault` | Unconfined, RuntimeDefault | Unconfined | SeccompDefault enables the use of RuntimeDefault as the default seccomp profile for all workloads. When RuntimeDefault, restricted syscalls in the containerd seccomp profile will fail. When Unconfined, syscalls will not be restricted. See [containerD default seccomp profile](https://github.com/containerd/containerd/blob/f0a32c66dad1e9de716c9960af806105d691cd78/contrib/seccomp/seccomp_default.go#L51) for more detail. This parameter is in preview and requires [registration](https://learn.microsoft.com/azure/azure-resource-manager/management/preview-features?tabs=azure-cli#register-preview-feature) of feature flag: 'KubeletDefaultSeccompProfilePreview'.|
