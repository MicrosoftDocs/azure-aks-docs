...
> [!IMPORTANT]
> If you don't configure certificates explicitly, Dapr will default to generating self-signed certificates. **Currently, using self-signed certificates generated by Dapr is not recommended.** Best practice is to generate custom certificates and update them manually.
