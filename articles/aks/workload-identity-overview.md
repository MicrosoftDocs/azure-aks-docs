...
:::image type="content" source="media/workload-identity-overview/aks-workload-id-model.png" alt-text="Diagram of the AKS workload identity security model." lightbox="media/workload-identity-overview/aks-workload-id-model.png":::
...
:::image type="content" source="media/workload-identity-overview/aks-workload-id-oidc-authentication-model.png" alt-text="Diagram of the AKS workload identity OIDC authentication sequence." lightbox="media/workload-id-overview/aks-workload-identity-oidc-authentication-model.png":::
