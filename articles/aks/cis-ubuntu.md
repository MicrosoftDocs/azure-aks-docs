...
* **Level:** L1, or Level 1, recommends essential basic security requirements that can be configured on any system and should cause little or no interruption of service or reduced functionality. L2, or Level 2, recommends stricter requirements for environments with a higher security posture.
* **Status:**
...
AKS node images aim to be L1 compliant where possible in a way that doesn't interfere with Kubernetes node operations. L2 compliance status is provided for informational purposes and is not actively a target.
