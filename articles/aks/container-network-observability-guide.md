...
- **Configure monitoring**: Set up [Azure Managed Grafana integration](./how-to-configure-container-network-logs.md#visualize-with-grafana-dashboards) for advanced visualizations
