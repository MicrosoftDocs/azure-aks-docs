...
* If you're using an Azure Linux GPU-enabled node pool, refer to your current AKS API version for the default behavior of automatic security patches on your cluster.
