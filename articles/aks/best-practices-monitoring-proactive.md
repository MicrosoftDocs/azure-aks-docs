...
| Azure Managed Prometheus Metric | To access Prometheus metrics, you need to enable Managed Prometheus. See [Azure Monitor and Prometheus](/azure/azure-monitor/essentials/prometheus-metrics-overview) for details on how to enable and view Prometheus metrics. | See [Azure Monitor managed service for Prometheus rule groups](/azure/azure-monitor/essentials/prometheus-rule-groups) |
