...
> [!IMPORTANT]
> Explicit versioning matching the control plane revision (ex: `istio.io/rev=asm-1-18`) is required. The default `istio-injection=enabled` label causes sidecar injection to skip the namespace.
