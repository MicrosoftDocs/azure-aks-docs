...
* LocalDNS is not compatible with [applied FQDN filter policies in Advanced Container Networking Services (ACNS)](https://learn.microsoft.com/en-us/azure/aks/how-to-apply-fqdn-filtering-policies).
