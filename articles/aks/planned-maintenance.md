...
Before you use a shared maintenance window, confirm that your Azure CLI or AKS preview extension version supports the shared maintenance-window commands.
