...
| Workload placement on managed system nodes | Scheduling or running customer workloads on AKS-managed hosted system nodes, including workloads with reserved tolerations, broad wildcard tolerations, or custom schedulers. | Helps prevent customer workloads from running on reserved system capacity. |
