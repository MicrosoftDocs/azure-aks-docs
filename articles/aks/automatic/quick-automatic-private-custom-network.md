...
|                                  | Users identity accessing the cluster with [`Azure Kubernetes Service Cluster User Role`](/role-based-access-control/built-in-roles/containers.md#azure-kubernetes-service-cluster-user-role) and [`Azure Kubernetes Service RBAC Writer`](/role-based-access-control/built-in-roles/containers.md#azure-kubernetes-service-rbac-writer) | 
...
[private-endpoint-service]: ../private-clusters.md#private-endpoint-service
