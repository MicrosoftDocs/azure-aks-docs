...
Downgrades aren't supported. Also, keep in mind that the further you are from a supported version, the higher the risk of upgrade problems. It might be better to consider creating a new cluster and migrating workloads.
...
- **Supported non-LTS**: A version that isn't LTS and is still listed as supported in the [AKS Kubernetes release calendar](#aks-kubernetes-release-calendar).
