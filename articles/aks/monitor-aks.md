...
| Application insights | [Azure Monitor Application Insights](/azure/azure-monitor/app/app-insights-overview) is an Application Performance Management (APM) tool for monitoring application-level signals. Application Insights collects logs, metrics, and distributed traces for performance and usage analysis in the Azure portal. For more information, see [Application monitoring for Kubernetes](/azure/azure-monitor/app/app-insights-overview/kubernetes-codeless). |
