...
PCI DSS 4.0.1 emphasizes minimizing standing privileges and encourages the use of just-in-time (JIT) access and conditional access policies. Enhanced monitoring and alerting for privileged access is required.
...
PCI DSS 4.0.1 requires that access control systems support continuous monitoring and alerting for unauthorized access attempts, and that all access control policies are regularly reviewed and updated.
