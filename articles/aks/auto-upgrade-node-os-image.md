...
> [!NOTE]
> Node OS image auto-upgrade won't affect the cluster's Kubernetes version. Starting API version 2023-06-01, the default for any new cluster created is `NodeImage`. 
