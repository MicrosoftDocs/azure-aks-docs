...
| **ACL with containerd and Gen 2, FIPS, Trusted Launch, and AMD64** | This is a variant of the standard ACL node image for for customers that enable [Federal Information Processing Standards (FIPS)](./enable-fips-nodes.md) and use Trusted Launch on an AMD64 VM size. Supports Generation 2 only. |
...
| **ACL with containerd and Gen 2, FIPS, Trusted Launch, and ARM64** | This is a variant of the standard ACL node image for for customers that enable [Federal Information Processing Standards (FIPS)](./enable-fips-nodes.md) and use Trusted Launch on an [Arm64](./use-arm64-vms.md) VM size. Supports Generation 2 only. |
